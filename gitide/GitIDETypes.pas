...
begin
  ...
  begin
    ...
    IDEClient.GitClient.SaveFileContentToStream(FileName, FFiles[I].Revision1, MemStream);
    ...
    IDEClient.GitClient.SaveFileContentToStream(FileName, FFiles[I].Revision2, MemStream);
  ...
  if not FAborted then
    ...
    begin
      ...
      (BorlandIDEServices as IOTACustomDifferenceManager).
        ShowDifference(FFiles[I].Stream1, FFiles[I].Stream2, FileName + '-' + Copy(FFiles[I].Revision1, 1, 7),
          FileName  + '-' + Copy(FFiles[I].Revision2, 1, 7), FileName, FileName, dfOTARevision, dfOTARevision, dtOTADefault);
