...
function ShowGitClientLoginPrompt(GitClient: TGitClient; const Realm: string;
  var UserName, Password: string; var Save: Boolean; Options: TLoginPromptOptions = []): TModalResult;
function ShowGitClientSSLClientPasswordPrompt(GitClient: TGitClient; const Realm: string;
...
begin
  ButtonOK.Enabled := (not (lpoUserName in FOptions) or ((EditUserName.Text <> '') and (EditPassword.Text <> '')));
end;
