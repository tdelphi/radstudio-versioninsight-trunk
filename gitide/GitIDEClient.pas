...
uses
  ...
  GitImages, GitIDEConst, GitIDEIcons, GitIDEFileStates, Dialogs;
...
begin
  ...
  try
    ...
    FGitClient.UserName := RegIniFile.ReadString('Git', 'UserName', '');
    FGitClient.UserEmail := RegIniFile.ReadString('Git', 'UserEmail', '');
  finally
    RegIniFile.Free;
  end;
end;
