...
resourcestring
  SLoginCaption = 'Please login to Git server.';
  SLoginRealmCaption = 'Please login to Git server:'#13#10'%s';
  ...
  sConfirmRemoveRemoteInfo = 'Are you sure to remove all the remote repository information?';
