...
uses
  ...
  ImgList, HgUITypes, Menus, ActnList;
...
uses HgUIConst, HgUIUtils, HgIDEConst, Clipbrd, FileCtrl;
...
begin
  ...
  try
    ...
    begin
      S := FilesSL[I];
      if (S[1] = 'M') and (not S.Contains(feForm) and not S.Contains(feFmxForm)) then
...
procedure THgLogFrame.CreateHandle;
var
  I: Integer;
begin
  inherited CreateWnd;
...
procedure THgLogFrame.FilesDblClick(Sender: TObject);
begin
